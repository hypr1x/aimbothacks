...
class App(threading.Thread):
    ...
    def run(self):
        ...
        self.enableAimbot.place(relx=0.20, rely=0.85, anchor=CENTER)
        ...
        self.enableOverlay.place(relx=0.40, rely=0.85, anchor=CENTER)

        self.showAimbot = customtkinter.CTkCheckBox(self.root, text="Show Aimbot", command=self.setShow)
        self.showAimbot.place(relx=0.60, rely=0.85, anchor=CENTER)

        self.darkMode = customtkinter.CTkCheckBox(self.root, text="Dark Mode", command=self.setDark)
        self.darkMode.select()
        self.darkMode.place(relx=0.80, rely=0.85, anchor=CENTER)
